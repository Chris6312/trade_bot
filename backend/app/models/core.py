...
class StockPaperContractLedger(TimestampMixin, Base):
    __tablename__ = "stock_paper_contract_ledger"
    __table_args__ = (
        UniqueConstraint("trade_date", "symbol", "strategy_name", name="uq_stock_paper_contract_ledger_trade_symbol_strategy"),
    )

    id: Mapped[int] = mapped_column(primary_key=True)
    trade_date: Mapped[str] = mapped_column(String(10), index=True, nullable=False)
    symbol: Mapped[str] = mapped_column(String(20), index=True, nullable=False)
    strategy_name: Mapped[str] = mapped_column(String(50), index=True, nullable=False, default="htf_reclaim_long")
    timeframe: Mapped[str] = mapped_column(String(10), nullable=False, default="5m")
    ai_named: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    ai_bucket: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
    ai_reason: Mapped[str | None] = mapped_column(Text(), nullable=True)
    ai_quality_1h: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ai_quality_15m: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ai_reclaim_state: Mapped[str | None] = mapped_column(String(30), nullable=True)
    ai_risk_note: Mapped[str | None] = mapped_column(Text(), nullable=True)
    ai_scanned_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True, index=True)
    strategy_status: Mapped[str | None] = mapped_column(String(20), nullable=True, index=True)
    candidate_timestamp: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True, index=True)
    pair_1h_used: Mapped[str | None] = mapped_column(String(40), nullable=True)
    pair_15m_used: Mapped[str | None] = mapped_column(String(40), nullable=True)
    bias_pass_1h: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    setup_pass_15m: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    trigger_pass_5m: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    indicator_approved: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    risk_status: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
    risk_decision_reason: Mapped[str | None] = mapped_column(Text(), nullable=True)
    entry_price: Mapped[Decimal | None] = mapped_column(Numeric(20, 8), nullable=True)
    stop_price: Mapped[Decimal | None] = mapped_column(Numeric(20, 8), nullable=True)
    target_price: Mapped[Decimal | None] = mapped_column(Numeric(20, 8), nullable=True)
    trade_taken: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    trade_status: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
    filled_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True, index=True)
    position_status: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
    ...
    notes_json: Mapped[list[str] | None] = mapped_column(JSON, nullable=True)
