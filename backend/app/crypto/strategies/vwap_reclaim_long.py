...
def evaluate(inputs: StrategyEvaluationInput):
    ...
    threshold = normalized_threshold(0.58, current_entry_policy(inputs))
    ...
    if relative_volume_20 is None or relative_volume_20 < 0.85:
    ...
    signal_score = ratio_score(reclaim_distance, target=0.015)
